...
class StatusMalamCard extends StatefulWidget {
  const StatusMalamCard({super.key});

  @override
  State<StatusMalamCard> createState() => _StatusMalamCardState();
}

class _StatusMalamCardState extends State<StatusMalamCard> {
  ...
  Color getCurrentColor() {
    ...
    DateTime start = DateTime.utc(now.year, now.month, now.day, 20, 00, 0);
    DateTime end = DateTime.utc(now.year, now.month, now.day, 21, 00, 0);

...
class StatusSiangCard extends StatefulWidget {
  const StatusSiangCard({super.key});

  @override
  State<StatusSiangCard> createState() => _StatusSiangCardState();
}

class _StatusSiangCardState extends State<StatusSiangCard> {
  ...
  Color getCurrentColor() {
    ...
    DateTime start = DateTime.utc(now.year, now.month, now.day, 13, 0, 0);
    DateTime end = DateTime.utc(now.year, now.month, now.day, 14, 0, 0);
